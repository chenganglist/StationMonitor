...
{
	int realtemperature =  temperature - 17;
	...
	unsigned char str[11] = {0xA0, 0xA1, 0xC1, 0xB1, 0x40,temperature_byte,
	...
	unsigned char order[14] = {0xAA, 0xA0, 0xA1, 0xC1, 0xB1, 0x40,temperature_byte,0x00,
	 0x00, 0x00, 0x00, 0x00, sum, 0x55 };
...
int main(int argc,char* argv[])
{
    ...
    //*********发送命令************** 
	int send_res = Send_order(fd,outcommand,14);
